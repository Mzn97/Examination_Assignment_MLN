            ...
            <nav className="navbar">
                ...
                <div className="navbar-container cart-container">
                    ...
                    <span className="navbar-item"><h2>Shopping Cart</h2></span>
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-shopping-cart" width="25" height="35" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#000000" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
