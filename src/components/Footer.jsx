      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            <li><Link to="/Information" style={{ color: '#666666', fontSize: '19px', marginTop: '20px', display: 'block' }}>Information</Link></li>
          </ul>
        </div>

        <div className="footer-section">
          <h4 style={{ lineHeight: '1', marginBottom: '5px' }}>
            Contact Us 
            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-device-mobile" width="44" height="30" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#000000" fill="none" strokeLinecap="round" strokeLinejoin="round" transform="translate(-6, 5)" > 
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
          ...
          <p style={{ marginTop: '10px' }}>Email: info@MLNK.com</p>
          <p style={{ marginTop: '10px' }}>Phone: +123 456 789</p>
        </div>
      </div>

      <div className="footer-bottom">
        <p style={{ fontSize: '14px' }}>&copy; {new Date().getFullYear()} Sweden MLNK, Inc. All Rights Reserved </p>
      </div>
    </footer>
  );
}
